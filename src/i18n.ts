    ...
    settings: {
      ...
      connections: {
        ...
        steam: {
          ...
          unlocks: "Desbloqueia: biblioteca oficial, tempo de jogo, conquistas e wishlist da Steam.",
        },
        discord: {
          title: "Discord",
    ...
    settings: {
      ...
      connections: {
        ...
        steam: {
          ...
          unlocks: "Unlocks: official library, playtime, achievements and Steam wishlist.",
        },
        discord: {
          title: "Discord",
